    ...
    hiList.html.header =
        ...
        '<select style="max-width: 60px;" class="form-control pull-right" ng-model="show.maxItems" ng-options="x for x in maxItemsOptions"></select>'+
        '</div>';
        ...
        directive.link = function($scope,element,attributes) {
            ...
            $scope.$doFilter = function(){
                ...
                if(!$scope.$filterInProgress){
                    ...
                    //TODO: Tell the status handler that the filtering is about to start
                    $scope.$filterInProgress = true

                    //TODO: Warn the extensions and give them chance the manipulate the filter params

                }


                console.log("filter function invoked");
                $scope.$ds.call({},param1,param2,param3)
