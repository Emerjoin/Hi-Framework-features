...
import com.web.yayee.config.ConfigLoader;
import com.web.yayee.frontier.Scripter;
import com.web.yayee.frontier.model.FrontierClass;
import com.web.yayee.frontier.model.BeansCrawler;
import com.web.yayee.mvc.MissingResourcesLibException;
import com.web.yayee.req.*;
 ...
 */
@WebServlet(urlPatterns = "/*",name = "YayeeServlet",loadOnStartup = 1)
public class Dispatcher extends HttpServlet {
    ...
    private void readLibScript() throws MissingResourcesLibException {
        ...
        try {
            ...
            URL res = this.getServletContext().getResource("/yayee.js");
            if(res!=null){
    ...
    private void generateFrontiers() throws ServletException {
            ...
            try {
                ...
                Class initializerclass = Class.forName("com.yayee.generated.FrontiersInitializer");
            ...
            if(beanClasses==null){
                ...
                System.out.println("No frontier found. Check if Yayee annotations processor is configured.");
                return;
    ...
    public void init() throws ServletException{
        ...
        if(AppConfigurations.get()!=null){
            ...
            ReqHandler.register(CDI.current().select(Yayee.class).get(),Yayee.class);
            ReqHandler.register(CDI.current().select(Frontiers.class).get(),Frontiers.class);
            Yayee.prepareTemplates(this.getServletContext());
