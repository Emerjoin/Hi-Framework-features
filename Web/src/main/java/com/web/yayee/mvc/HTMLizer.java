...
public class HTMLizer {
    ...
    private static final String PREPARE_NEXT_VIEW = "Yapiys.Internal.prepareNextViewContext(false,context_vars,null,true);";
    ...
    private String getLoaderJavascript(FrontEnd frontEnd){
        ...
        scriptBuilder.append("angular.bootstrap(document, [\"yapiys\"]);");
    ...
    private String getNextClosureInformation(){
        ...
        String functionInvocation = "Yapiys.Internal.setNextClosureInformation(false,\""+controller+"\",\""+action+"\");";
    ...
    private String getNextViewPath(){
        ...
        String controller = requestContext.getData().get("controller").toString();
        String action = requestContext.getData().get("action").toString();
        String functionInvocation = "Yapiys.Internal.setNextViewPath(false,\""+controller+"\",\""+action+"\");";
        return functionInvocation;
    ...
    private String getControllerSetter(){
        ...
        String controller = requestContext.getData().get("controller").toString();
        String action = requestContext.getData().get("action").toString();
        String functionInvocation = "Yapiys.setLoadedController(\""+controller+"\",\""+action+"\");";
        return functionInvocation;
    ...
    public String process(Controller controller,boolean ignoreView) throws TemplateException, ConversionFailedException {
        ...
        String loadedJSContent= Dispatcher.yayeeLoaderScript;
