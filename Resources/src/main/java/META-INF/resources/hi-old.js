...
delete a.$$listenerCount[c];while(a=a.$parent)}function q(){}function t(){for(;z.length;)try{z.shift()()}catch(a){f(a)}e=null}function p(){null===e&&(e=h.defer(function(){w.$apply(t)}))}m.prototype={constructor:m,$new:function(b,c){var d;c=c||this;b?(d=new m,d.$root=this.$root):(this.$$ChildScope||(this.$$ChildScope=a(this)),d=new this.$$ChildScope);d.$parent=c;d.$$prevSibling=c.$$childTail;c.$$childHead?(c.$$childTail.$$nextSibling=d,c.$$childTail=d):c.$$childHead=c.$$childTail=d;(b||c!=this)&&d.$on("$destroy",
    ...
    c&&n(c,function(c){d?(new RegExp("(^|\\s)"+xd(b)+"(\\s|\\||$)")).test(c)&&g.push(a):-1!=c.indexOf(b)&&g.push(a)})});return g},findModels:function(a,b,d){for(var g=["ng-","data-ng-","ng\\:"],h=0;h<g.length;++h){var k=a.querySelectorAll("["+g[h]+"controller"+(d?"=":"*=")+'"'+b+'"]');if(k.length)return k}},getLocation:function(){return d.url()},setLocation:function(b){b!==d.url()&&(d.url(b),a.$digest())},whenStable:function(a){b.notifyWhenNoOutstandingRequests(a)}}}]}function Df(){this.$get=["$rootScope",
...
Hi.UI.prepareView = function(route_name_or_object){
    ...
    if(route){
        ...
        var path = Hi.Internal.getTextViewPath(route.controller, route.action);
...
Hi.UI.viewControllers={};


Hi.UI.viewControllersDeclared = new Array();
...
Hi.Internal.getViewPath = function(controller,action){
...
Hi.Internal.getTextViewPath = function(controller, action){

    return controller+"_"+action;

};

Hi.Internal.getViewController = function(controllerName, actionName){

    var view_path = Hi.Internal.getTextViewPath(controllerName,actionName);
...
Hi.Internal.setViewController= function(controllerName, actionName, controller){
    var view_path = Hi.Internal.getTextViewPath(controllerName,actionName);
...
Hi.Internal.prepareNextViewContext = function(viewPath,context_variables,markup,embbeded,receptor,$embbedScope,embbedOptions){


    //Get the view controller
    var controller = Hi.Internal.getViewController(viewPath.controller,viewPath.action);
    ...
    if(embbeded){
        ...
        if(typeof $embbedScope!="undefined"){

            viewScope = $embbedScope.$new(false);
    ...
    Hi.Internal.applyViewControllerProperties(viewScope,context_variables);
    ...
    if(embbeded){
        ...
        if(typeof embbedOptions.preEmbbed!="undefined"&&typeof viewScope.$preEmbbed!="undefined"){

            viewScope.$preEmbbed.call(viewScope,embbedOptions.preEmbbed);
...
Hi.Internal.callMeBack = function(dialog,context_variables,markup,embbeded){
    ...
    if(!embbeded){
        ...
        context=Hi.Internal.viewController;
...
Hi.Internal.createViewController = function(dialog, context_variables, markup){
...
/*
 Hi.Internal.getViewController = function() {


 if (Hi.Internal.nextViewPath) {

 var controllerName = Hi.Internal.nextViewPath.controller;
 var actionName = Hi.Internal.nextViewPath.action;
 var postLoad = false;
 var preLoad = false;


 var controller = Hi.Internal.getViewController(controllerName, actionName);
...
Hi.Internal.applyViewControllerProperties = function(context,context_variables){
...
Hi.Internal.bindParamsAndClosures = function(context,context_variables){
    ...
    if(Hi.Internal.nextViewPath){
        ...
        var closures=Hi.Internal.getViewController(controllerName,actionName);
        ...
        if(closures){
            ...
            console.log("Closures NOT found for "+controllerName+"/"+actionName);
...
Hi.UI.Interface = function(route){
    ...
    var closures = Hi.Internal.getViewController(route_.controller,route_.action);
...
Hi.route = function(route_name_or_object,getParams,embbed,callback,$embbedScope,embbedOptions){
    ...
    if(!route_object.dialog){
        ...
        Hi.Internal.getRoute(route_object,function(server_response){
            ...
            if(server_response.controller) {
                ...
                Hi.Internal.setNextControllerInfo(route_object.controller, route_object.action);
            ...
            var viewPath =  Hi.Internal.getViewPath(controller,action);//New
            ...
            if(embbed){
                ...
                if(typeof embbedOptions!="undefined"){


                    if(embbedOptions.silentUrl){
            ...
            var generated = Hi.Internal.prepareNextViewContext(viewPath,context_variables,markup,embbed,{},$embbedScope,embbedOptions);
...
Hi.Internal.nextControllerInfo = {};
Hi.Internal.setNextControllerInfo = function(controller, action){
    Hi.Internal.nextControllerInfo = {controller:controller,action:action};
};
...
Hi.view = function(controller){
    ...
    var viewPath = Hi.Internal.nextControllerInfo;

    //Resolved route
    var route = Hi.routes.resolve(viewPath);

    //Rota correspondente a esta view
    controller.$route = route;

    //Regista o controller
    Hi.Internal.setViewController(viewPath.controller,viewPath.action,controller);

    //Gera o path do controller
    var path = Hi.Internal.getTextViewPath(viewPath.controller,viewPath.action);

    //Considera este controller declarado
    Hi.UI.viewControllersDeclared.push(path);
...
if(Array.isArray(modulesInjected)){
    ...
    throw new Error("Invalid value set for property Hi.setup.modules");
...
angularApp.directive("embbed",function(){

    //TODO: Prevent self embbed
    ...
    return {
        ...
        link:function($scope,element, attrs){
            ...
            if(attrs.hasOwnProperty(silentUrlAttr)){
                ...
                embbedOptions.silentUrl = $scope.$eval(attrs[silentUrlAttr]);
            ...
            Hi.route(url,false,true,function(receptor){
                ...
                $scope.$applyAsync(function(){
                    ...
                    $(element).find(".embbed-loader").hide();
...
Hi.getServerGroup = function(path_object_){
    ...
    var path = Hi.Internal.getTextViewPath(path_object.controller,path_object.action);
